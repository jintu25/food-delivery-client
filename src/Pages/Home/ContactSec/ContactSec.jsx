  ...
  return (
    <div className="container my-20 mx-auto md:px-6">
      <section className="mb-20">
        <div className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-900">
          <div className="flex flex-wrap items-center">

            <div className="block w-full shrink-0 grow-0 basis-auto lg:flex lg:w-6/12 xl:w-4/12">
              <div className="h-[500px] w-full">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3650.048585237776!2d90.41251871539092!3d23.810332684567006!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755a5d4eb85556d%3A0x2c1fa86eb79ed2e9!2sDhaka!5e0!3m2!1sen!2sbd!4v1665950702096!5m2!1sen!2sbd"
